...
export default async function EditorSpecialCasesPage() {
    ...
    <div className="flex flex-col gap-6">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          یک پرونده بسازید و اخبار مرتبط با آن موضوع را به آن اضافه کنید.
        </p>
      </header>
      ...
      {dbError ? (
        ...
        <SpecialCasesManager
          basePath="/dashboard/editor/special-cases"
          cases={cases.map((c) => ({
            id: c.id,
            slug: c.slug,
            title: c.title,
